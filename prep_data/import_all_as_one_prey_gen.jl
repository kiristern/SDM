...
cd("/Users/kiristern/Documents/GitHub/SDM/data/prey_genus/")
...
df = df_prey[:, [:genus, :species, :infraspecificEpithet, :taxonRank, :decimalLatitude, :decimalLongitude, :year]]
...
#save csv file
CSV.write("prey_gen_onedf.csv", df)
