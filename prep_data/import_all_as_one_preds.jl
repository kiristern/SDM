...
cd("/Users/kiristern/Documents/GitHub/SDM/data/preds/originals")
...
df = df_pred[:, [:species, :infraspecificEpithet, :taxonRank, :decimalLatitude, :decimalLongitude, :year]]
