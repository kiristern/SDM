...
cd("/Users/kiristern/Documents/GitHub/SDM/data/prey_family/")
...
df = df_prey[:, [:family, :species, :infraspecificEpithet, :taxonRank, :decimalLatitude, :decimalLongitude, :year]]
...
#save csv file
CSV.write("prey_fam_onedf.csv", df)
